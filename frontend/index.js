function moduleProject1() {
  ...
  //  ✨ add your code here
      ...
      authorDate.textContent =`${author} in ${date || "an unknow date"}`
  ...
  personParagraph.textContent = `${person.fname} ${person.lname} was born in ${year} and is friends with  `
  let sentence = `${person.fname} ${person.lname} was born in ${year} and is friends with  `
